from simple_colors import * # 화면 출력 시 컬러 지원
...
# 메인 영역
if __name__ == "__main__":  # main thread 흐름을 타는 시작점 / 시작 지점을 정할 수 있음
